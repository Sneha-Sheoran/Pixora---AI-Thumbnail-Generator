                    ...
                    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <article>
                            <div class="relative w-full aspect-video rounded-xl overflow-hidden">
                                <img src="%%THUMBNAIL_URL%%" class="w-full h-full object-cover object-top" />
                                <div class="absolute inset-0 p-4 flex items-end justify-start pointer-events-none">
                                    <h2 class="text-lg font-extrabold text-white drop-shadow-2xl leading-tight uppercase tracking-wide max-w-[70%] text-left" style="text-shadow: 2px 2px 4px rgba(0,0,0,0.9), 0px 0px 2px rgba(0,0,0,0.7);">
                                        %%TITLE%%
                                    </h2>
                                </div>
                            </div>
